        ...
        <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-300 mb-8 text-lg">
              New to our platform? Sign up now and explore our library.
            </p>
            <Link
              to="/register"
              className="inline-block border-2 border-white px-8 py-2 rounded-lg font-semibold hover:bg-white hover:text-black transition duration-300"
            >
              Sign Up
            </Link>
          </div>
